...
from . import insight_rule_config
...
class PsychoanalysisInsightEvaluator(ExitEvaluator[PsychoanalysisGraphState]):
    MAX_ATTEMPTS = 3
    MAX_STALLS = 2

    def evaluate(self, state: PsychoanalysisGraphState, technique_id: str) -> ExitEvaluationResult:
        rule = insight_rule_config.get_insight_rule(technique_id)
