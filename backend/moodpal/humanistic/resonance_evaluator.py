...
from . import resonance_rule_config
...
class HumanisticResonanceEvaluator(ExitEvaluator[HumanisticGraphState]):
    MAX_ATTEMPTS = 3
    MAX_STALLS = 2

    def evaluate(self, state: HumanisticGraphState, technique_id: str) -> ExitEvaluationResult:
        rule = resonance_rule_config.get_resonance_rule(technique_id)
